...
DESCRIPTION: using DFA as a basis, this function uses multiple if/else statements to parse through the user input character by character to recognize the string and then print its translation to the user
*/
